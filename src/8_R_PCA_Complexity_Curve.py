...
Overview:
    ...
    amend model_name to the winning model
...
from config import RIEMANN_DATA_DIR, RIEMANN_FIGURES_DIR, RANDOM_STATE, SAVED_MODELS_DIR
...
def plot_complexity_curve():
    ...
    max_features = min(20, X_ts.shape[1]) #max 20 features
