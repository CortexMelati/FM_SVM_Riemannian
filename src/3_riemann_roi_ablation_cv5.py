...
Execution:
    python 3_riemann_roi_ablation_cv5.py
=============================================================================
"""
...
def run_ablation():
    ...
    comprehensive_path = RIEMANN_DATA_DIR / "riemann_comprehensive_scoreboard_cv5.csv"
    ...
    for band_name in best_bands:
        ...
        for p_name in architectures:
            ...
            best_name = f"model_riemann_{band_name}_{layout_str}_{p_name}_cv5.pkl"
