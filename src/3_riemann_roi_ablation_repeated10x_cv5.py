...
Execution:
    python 3_riemann_roi_ablation_repeated10x_cv5.py
=============================================================================
"""
...
def run_ablation():
    ...
    comprehensive_path = RIEMANN_DATA_DIR / "riemann_comprehensive_scoreboard_10x_cv5.csv"
    ...
    for band_name in best_bands:
        ...
        for p_name in architectures:
            ...
            # range = amount of repeats of 5-Fold Stratified Group CV
            cv_repeated = []
            for i in range(10):
            ...
            # Freezing the winning model after fit
            layout_str = 'whole' if RUN_AS_WHOLE_BRAIN else 'roi'
            best_name = f"model_riemann_{band_name}_{layout_str}_{p_name}_10x_cv5.pkl"
